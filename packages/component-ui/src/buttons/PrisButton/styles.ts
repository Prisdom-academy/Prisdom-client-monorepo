...
import { ButtonTokenColor, ColorToken } from "@prisdom/theme/base/interfaces";
...
export const PrisButtonStyle = defineStyleConfig({
  ...
  variants: {
    primary: {
      backgroundColor: ButtonTokenColor.cpn_btn_primary_background_default,
      color: "white",
    ...
    tertiary: {
      backgroundColor: ButtonTokenColor.cpn_btn_neutral_background_default,
      ...
      _loading: {
        ...
        fill:
          ButtonTokenColor.cpn_btn_neutral_background_loading + " !important",
      },
      _focus: {
        bg: ButtonTokenColor.cpn_btn_neutral_background_hover,
        outline: `3px solid`,
        outlineColor: ButtonTokenColor.cpn_btn_neutral_background_hover,
        border: "1px solid",
